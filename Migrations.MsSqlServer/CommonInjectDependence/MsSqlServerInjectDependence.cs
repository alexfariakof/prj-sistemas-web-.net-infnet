...
public static class MsSqlServerInjectDependence
{
    public static IServiceCollection AddMsSqlServerRegisterContext(this IServiceCollection services, IConfiguration configuration)
    {
