...
namespace Migrations.MySqlServer.Migrations.Application
{
    ...
    [Migration("20240628040405_Convert-PKs-Type-GUID-to-Binary")]
    partial class ConvertPKsTypeGUIDtoBinary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlatMusic", b =>
                {
                    b.Property<byte[]>("FlatsId")
                        .HasColumnType("binary(16)");

                    b.Property<byte[]>("MusicsId")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("MusicPlayListPersonal", b =>
                {
                    ...
                    b.Property<byte[]>("PlaylistPersonalId")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("Domain.Transactions.Agreggates.Transaction", b =>
                {
                    ...
                    b.OwnsOne("Domain.Core.ValueObject.Monetary", "Monetary", b1 =>
                        {
                            b1.Property<byte[]>("TransactionId")
                                .HasColumnType("binary(16)");
