...
projectAngular="$projectPath/Angular"
...
dotnet test  ./XunitTest.csproj --results-directory "$reportPath" -p:CollectCoverage=true -p:CoverletOutputFormat=cobertura --collect:"XPlat Code Coverage;Format=opencover" --no-restore --no-build 
